    ...
    static getLevelHtml(level) {
        ...
        switch (level) {
            case config.freelancerLevels.junior:
                levelHtml = '<span class="badge btn-info">Junior</span>';
                break;
            case config.freelancerLevels.middle:
                levelHtml = '<span class="badge btn-warning">Middle</span>';

                break;
            case config.freelancerLevels.senior:
                levelHtml = '<span class="badge btn-success">Senior</span>';
                break;
            default:
                levelHtml = '<span class="badge btn-secondary">Unknown</span>';
        }
        return levelHtml;
    }
